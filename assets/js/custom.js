...
$(".content-wrapper").on("click",".modalButtonPendidikan", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'pendidikan/modal_pendidikan',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_pendidikan').find('.modal-body').html(data);
      $('#nameModal_pendidikan').modal('show'); 
    })
  });
  
$(".content-wrapper").on("click",".modalButtonPenelitian", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'penelitian/modal_penelitian',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_penelitian').find('.modal-body').html(data);
      $('#nameModal_penelitian').modal('show'); 
    })
  });
  $(".content-wrapper").on("click",".modalButtonPengabdian", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'pengabdian/modal_pengabdian',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_pengabdian').find('.modal-body').html(data);
      $('#nameModal_pengabdian').modal('show'); 
    })
  });
  
  $(".content-wrapper").on("click",".modalButtonPenunjang", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'penunjang/modal_penunjang',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_penunjang').find('.modal-body').html(data);
      $('#nameModal_penunjang').modal('show'); 
    })
  });
  
  $(".content-wrapper").on("click",".modalButtonProfesor", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'profesor/modal_profesor',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_profesor').find('.modal-body').html(data);
      $('#nameModal_profesor').modal('show'); 
    })
  });
   $(".content-wrapper").on("click",".modalButtonBKD", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'bkd/modal_bkd',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_bkd').find('.modal-body').html(data);
      $('#nameModal_bkd').modal('show'); 
    })
  });
   $(".content-wrapper").on("click",".modalButtonBKDFile", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'bkd/modal_bkdfile',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
   ...
   $(".content-wrapper").on("click",".modalButtonBKDStatus", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'bkd/modal_bkdStatus',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_bkdStatus').find('.modal-body').html(data);
      $('#nameModal_bkdStatus').modal('show'); 
    })
  });
    $(".content-wrapper").on("click",".modalButtonAsesor", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'user/modal_Asesor',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_Asesor').find('.modal-body').html(data);
      $('#nameModal_Asesor').modal('show'); 
    })
  });
...
function delFile(id, module) {
  var url =  $('body').attr('data-base-url');
  $("#cnfrm_delete").find("a.yes-btn").attr("href",url+"/"+ module +"/deletefile/"+id);
}
